...
const expectedFileResponse = require("./mock/simpleFileResponse.json");
require("whatwg-fetch");
const NodeFileReader_1 = require("../src/readers/NodeFileReader");
const config = {
    mockFolder: __dirname,
    responseFileRetriever: NodeFileReader_1.nodeResponseFileRetriever,
    requests: [
        {
            method: 'GET',
            path: {
...
describe('FetchStub Config tests', () => {
    ...
    it('should not match simple post request', () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            expect(error).toBeInstanceOf(src_1.MissingDescriptorError);
        }
    }));
});
describe('Response File check', () => {
    it('should match file', () => __awaiter(this, void 0, void 0, function* () {
