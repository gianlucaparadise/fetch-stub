...
class RequestMatcher {
    constructor(config, extraConfigs) {
        this.config = config;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (d.responseFile) {
                if (!this.config.mockFolder) {
                    throw new types_1.MockConfigError("Mock folder not defined");
                }
                if (!this.extraConfigs.responseFileRetriever) {
                    throw new types_1.MockConfigError("FileRetriever function not defined");
                }
                let responsePath = d.responseFile;
                const retrieveResponseFile = this.extraConfigs.responseFileRetriever;
                responseBody = yield retrieveResponseFile(this.config.mockFolder, responsePath);
            }
            else {
